...
namespace crud_user_data.Migrations
{
    ...
    [Migration("20251224065607_AddTablesFixed")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("crud_user.domain.Models.Attendance", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("crud_user.domain.Models.Department", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("crud_user.domain.Models.LeaveRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("crud_user.domain.Models.Payroll", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("crud_user.domain.Models.Position", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("crud_user.domain.Models.Attendance", b =>
                {
                    b.HasOne("crud_user.domain.Models.User", "User")
            ...
            modelBuilder.Entity("crud_user.domain.Models.User", b =>
                {
                    b.HasOne("crud_user.domain.Models.Department", "Department")
                        .WithMany("Users")
                        .HasForeignKey("DepartmentId");

                    b.HasOne("crud_user.domain.Models.Position", "Position")
                        .WithMany("Users")
